...
return [
    ...
    'notifications' => [
        'notifications' => [
            // Utiliser nos classes de notification personnalisées qui ne font rien
            // Cela évite l'erreur "There is no notification class that can handle event"
            \App\Notifications\Backup\BackupHasFailedNotification::class => [],
            \App\Notifications\Backup\BackupWasSuccessfulNotification::class => [],
            \App\Notifications\Backup\CleanupHasFailedNotification::class => [],
            ...
            \App\Notifications\Backup\UnhealthyBackupWasFoundNotification::class => [],
        ],
