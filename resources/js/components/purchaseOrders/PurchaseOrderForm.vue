        ...
        <div class="row g-4">
          <div class="col-lg-6">
            <div class="card sale-card h-100">
              ...
              <div class="card-body">
                <div v-if="hasDeliveries" class="alert alert-warning mb-3">
                  <i class="bi bi-exclamation-triangle me-1"></i>
                  Ce bon de commande possède des bons de livraison associés. Modifiez les articles avec prudence.
                </div>
                ...
                <div class="row g-3 mb-3">
                  <div class="col-md-6">
                    ...
                    <div v-if="isSystemStatusDisplay" class="pt-1">
                      <span class="badge" :class="getStatusBadgeClass(form.status)">
                        {{ statusLabel }}
                      </span>
                      <small class="form-text text-muted d-block mt-1">
                        Statut géré automatiquement par les livraisons.
                      </small>
                    </div>
                    <template v-else>
                      <select
                ...
                <div class="mb-3">
                  ...
                  <small class="form-text text-muted">Date prévue de réception (optionnel)</small>
                </div>
              ...
              <div class="card-body">
                <div class="sale-adjust-row mb-4">
                  ...
                  <div v-show="taxEnabled">
                    <div class="btn-group w-100 mb-2" role="group">
                      <input id="po-tax-mode-amount" v-model="taxMode" type="radio" class="btn-check" value="amount" />
                      <label class="btn btn-outline-secondary btn-sm" for="po-tax-mode-amount">Montant</label>
                      <input id="po-tax-mode-percent" v-model="taxMode" type="radio" class="btn-check" value="percent" />
                      <label class="btn btn-outline-secondary btn-sm" for="po-tax-mode-percent">Pourcentage</label>
                    </div>
                ...
                <div class="sale-adjust-row mb-4">
                  ...
                  <div v-show="discountEnabled">
                    <div class="btn-group w-100 mb-2" role="group">
                      <input
                        id="po-discount-mode-amount"
                        v-model="discountMode"
                        type="radio"
                        class="btn-check"
                        value="amount"
                      />
                      <label class="btn btn-outline-secondary btn-sm" for="po-discount-mode-amount">Montant</label>
                      <input
                        id="po-discount-mode-percent"
                        v-model="discountMode"
                        type="radio"
                        class="btn-check"
                        value="percent"
                      />
                      <label class="btn btn-outline-secondary btn-sm" for="po-discount-mode-percent">Pourcentage</label>
                    </div>
        ...
        <FormActionsBar class="form-actions-bar--split">
          ...
          <div class="d-flex flex-column flex-sm-row gap-2 order-2 order-sm-2 ms-sm-auto">
            ...
            <button
              ...
              :disabled="processing || form.items.length === 0 || !form.supplier_id"
...
import {
  ...
  type PurchaseOrderFormProduct,
  type PurchaseOrderFormPurchase,
  type PurchaseOrderFormSupplier,
...
const previewPurchaseOrder = async () => {
  ...
  try {
    const filename =
      props.mode === 'edit' && props.purchaseOrder
        ? `BC_${props.purchaseOrder.po_number}.pdf`
        : 'Apercu_BC.pdf'
    await openFromPayload('purchase-orders.preview', payload, filename)
  } finally {
