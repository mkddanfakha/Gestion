...
export function route(name: string, params: any = {}) {
    const routes: Record<string, string> = {
        ...
        'admin.roles-permissions.index': '/admin/roles-permissions',
        ...
        'admin.backups.create-status': '/admin/backups/create-status/{jobId}',
        'admin.backups.inspect': '/admin/backups/{backup}/inspect',
        'admin.backups.verify-integrity': '/admin/backups/{backup}/verify-integrity',
